...
<html>
	<head>
		<title>Wholesale It - Largest Online Wholesale Marketplace!</title>
	...
	<body style="min-width: 980px;">
		<div class="homepageheader" style="position: relative;">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: #fff;" href="profile.php?id='.$user.'">Hi '.$uname_db.'</a>';
						}
						else {
			...
			<div style="float: left; margin: 5px 0px 0px 23px;">
				<a href="index.php">
					<img style=" height: 75px; width: 130px;" src="image/wholesaleitlogo.png">
				</a>
			</div>
			<div class="">
				<div id="srcheader">
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/homebackgrndimg.png); height: 380px; ">
				<h1 style="margin: 0px;">Welcome To WholesaleIt</h1>
				<h2>Largest Online Wholesale Marketplace in Bangladesh</h2>
			</div>
		</div>
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3254.0809397116377!2d90.38677394534847!3d23.876458187699704!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c413f9941279%3A0x2c653e889eb81ecb!2s24-6%20Rd%20No%2016%2C%20Dhaka%201230!5e1!3m2!1sen!2sbd!4v1575437405713!5m2!1sen!2sbd" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
