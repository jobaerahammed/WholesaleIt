...
$pCode = $_POST['code'];
$descri = $_POST['descri'];
$photos = $_POST['profilepic'];
//triming name
$_POST['pname'] = trim($_POST['pname']);

//finding file extention
$profile_pic_name = @$_FILES['profilepic']['pname'];
...
if (((@$_FILES['profilepic']['type']=='image/jpeg') || (@$_FILES['profilepic']['type']=='image/png') || (@$_FILES['profilepic']['type']=='image/gif')) && (@$_FILES['profilepic']['size'] < 1000000)) {
	...
	if (file_exists("../image/product/$item/".$filename)) {
		echo @$_FILES["profilepic"]["pname"]."Already exists";
	}else {
		...
		//echo "Uploaded and stored in: userdata/profile_pics/$item/".@$_FILES["profilepic"]["pname"];
